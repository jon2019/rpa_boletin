-- Modelo relacional para PostgreSQL/PostgREST
-- Generado a partir del diccionario de datos del proyecto
...
-- Recomendado para PostgREST: crear vistas o funciones si necesitas endpoints personalizados
-- y asegurarte de que los nombres de tablas y columnas sean en minúsculas y sin acentos.
